...
#ifndef TENSORFLOW_LITE_PLANE_DETECTION_IMAGE_PROVIDER_H_
#define TENSORFLOW_LITE_PLANE_DETECTION_IMAGE_PROVIDER_H_
...
#endif  // TENSORFLOW_LITE_PLANE_DETECTION_IMAGE_PROVIDER_H_
